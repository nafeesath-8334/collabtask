    ...
    <nav className="bg-gray-800 text-white shadow-md">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="hidden md:flex items-center space-x-6">
            {role === "admin" ? (
              <>
                <Link to="/addProject" className="hover:text-indigo-400">
                  Projects
                </Link>
                <Link to="/addTask" className="hover:text-indigo-400">
                  Tasks
                </Link>
                <Link to="/addTeam" className="hover:text-indigo-400">
                  Teams
                </Link>
                <Link to="/viewAllProjects" className="hover:text-indigo-400">
                  View
                </Link>
              </>
            ) : (
              <>
                <Link to="/mywork" className="hover:text-indigo-400">
                  My Work
                </Link>
              </>
            )}
            ...
            <button onClick={handleLogout} className="hover:text-indigo-400">
              Logout
            </button>
          </div>
      ...
      {menuOpen && (
        <div className="md:hidden bg-gray-700">
          {role === "admin" ? (
            <>
              <Link to="/addProject" className="block px-4 py-2 hover:bg-gray-600">
                Projects
              </Link>
              <Link to="/addTask" className="block px-4 py-2 hover:bg-gray-600">
                Tasks
              </Link>
              <Link to="/addTeam" className="block px-4 py-2 hover:bg-gray-600">
                Teams
              </Link>
              <Link to="/viewAllProjects" className="block px-4 py-2 hover:bg-gray-600">
                View
              </Link>
            </>
          ) : (
            <Link to="/mywork" className="block px-4 py-2 hover:bg-gray-600">
              My Work
            </Link>
          )}

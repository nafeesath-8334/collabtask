        ...
        <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100 py-8 px-4">
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <h2 className="text-3xl font-bold">Your Profile Information</h2>
                    <p className="text-gray-500 text-sm mt-1">
                       Update your personal details and preferences</p>
                </div>
                    <form onSubmit={handleSubmit} className="p-6">
                        ...
                        <div className="flex gap-4 justify-end pt-4 border-t border-gray-200">
                            ...
                            <button 
                                type="submit"
                                disabled={isLoading}
                                className="px-6 py-2 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition flex items-center justify-center disabled:opacity-70"
                            >
                                {isLoading ? (
                                    <>
